<template>
    <div class="v-table-views v-table-class"
                                ...
                                <tr v-for="row in frozenTitleCols">
                                    <td v-for="col in row"
                                        ...
                                        <div :class="['v-table-title-cell',showVerticalBorder?'vertical-border':'',showHorizontalBorder?'horizontal-border':'']"
                                             :style="{'width':titleColumnWidth(col.fields)+'px',
                                             'height':titleColumnHeight(col.rowspan)+'px',
                                             'text-align':col.titleAlign,
                                              'font-size':col.cellStyle?(col.cellStyle.fontSize?col.cellStyle.fontSize+'px':'16px'):'16px',
                                             'color':col.cellStyle?(col.cellStyle.fontColor?col.cellStyle.fontColor:'#2c3e50'):'#2c3e50',
                                             'backgroundColor':col.cellStyle?(col.cellStyle.bgColor?col.cellStyle.bgColor:'#ffffff'):'#ffffff',
                                             }"
                                              v-show="tableTitleShow"
                                             @click.stop="headCellEditClick($event,col.headIsEdit,row,col.field)"
                                             @contextmenu.prevent="contentMenuClick($event,row,col.field,'title')"
                                        >

                                            <span class="table-title">
                                               <span class="checkbox-span" v-if="isSelectionCol(col.fields)">
                                                     <v-checkbox
                                ...
                                <tr class="v-table-header-row">
                                    <td v-for="col in frozenCols"
                                        ...
                                        <div :class="['v-table-title-cell',showVerticalBorder?'vertical-border':'',showHorizontalBorder?'horizontal-border':'']"
                                             ...
                                             v-show="tableTitleShow"
                                             @click.stop="headCellEditClick($event,col.headIsEdit,frozenCols,col.field)"
                                             @contextmenu.prevent="contentMenuClick($event,frozenCols,col.field,'title')"
                                        >
                                ...
                                <tr v-for="(item,rowIndex) in internalTableData" class="v-table-row"
                                    ...
                                    <td v-if="cellMergeInit(rowIndex,col.field,item,true)"
                                        ...
                                        <div v-if="isCellMergeRender(rowIndex,col.field,item)"
                                             :class="['v-table-body-cell',showVerticalBorder ? 'vertical-border':'',showHorizontalBorder?'horizontal-border':'',col.isEdit?'text-div':'disable-text-div']"
                                             :style="{'width':getRowWidthByColSpan(rowIndex,col.field,item)+'px',
                                             ...
                                             'font-size':item[col.field]?(item[col.field].cellStyle?(item[col.field].cellStyle.fontSize?item[col.field].cellStyle.fontSize+'px':'16px'):'16px'):'',
                                             'color':item[col.field]?(item[col.field].cellStyle?(item[col.field].cellStyle.fontColor?item[col.field].cellStyle.fontColor:'#2c3e50'):'#2c3e50'):'',
                                             'backgroundColor':item[col.field]?(item[col.field].cellStyle?(item[col.field].cellStyle.bgColor?item[col.field].cellStyle.bgColor:'#ffffff'):'#ffffff'):'',
                                            }"
                                             :title="col.overflowTitle ?  overflowTitle(item,rowIndex,col) :''"
                                             @click.stop="rowCellClick(rowIndex,item,col);cellEditClick($event,col.isEdit,item,col.field,rowIndex,frozenCols)"
                                             @dblclick.stop="rowCellDbClick(rowIndex,item,col)"
                                             @contextmenu.prevent="contentMenuClick($event,internalTableData,col.field,'content',rowIndex)"
                                        >

                                            <span class="conponent-span" v-if="cellMergeContentType(rowIndex,col.field,item).isComponent">
                                            ...
                                            <span :class="col.isEdit?'text-sapn':'disable-text-span'" v-else v-html="cellMerge(rowIndex,item,col.field).content"></span>
                                        ...
                                        >
                                            ...
                                            <span class="conponent-span" v-if="typeof col.componentName ==='string' && col.componentName.length > 0">
                                                <component :rowData="item" :field="col.field ? col.field : ''"
                                                           :index="rowIndex" :is="col.componentName"
                                                           @on-custom-comp="customCompFunc"></component>
                                            </span>

                                            <span class="formate-span" v-else-if="typeof col.formatter==='function'"
                                                  v-html="col.formatter(item,rowIndex,pagingIndex,col.field)">
                                            </span>

                                            <span class="checkbox-span" v-else-if="col.type === 'selection'">
                                                <v-checkbox @change="handleCheckChange(item)" :show-slot="false"
                                                        :disabled="item._disabled" :label="rowIndex"></v-checkbox>
                                            </span>

                                            <span :class="col.isEdit?'text-sapn':'disable-text-span'" v-else>
                            ...
                            <tr class="v-table-header-row">
                                <td v-for="(col,colIndex) in noFrozenCols"
                                    ...
                                    <div :class="['v-table-title-cell',showVerticalBorder?'vertical-border':'',showHorizontalBorder?'horizontal-border':'']"
                                         ...
                                         v-show="tableTitleShow"
                                         @click.stop="headCellEditClick($event,col.headIsEdit,noFrozenCols,col.field)"
                                         @contextmenu.prevent="contentMenuClick($event,noFrozenCols,col.field,'title')"
                                    >
                                                                    <span class="table-title">
                                      <span v-if="col.type === 'selection'">
                                           <v-checkbox
                        ...
                        >
                            <td v-if="cellMergeInit(rowIndex,col.field,item,false)"
                                ...
                                <div  v-if="isCellMergeRender(rowIndex,col.field,item)"
                                     ...
                                     :title="col.overflowTitle ?  overflowTitle(item,rowIndex,col) :''"
                                     @click.stop="rowCellClick(rowIndex,item,col);cellEditClick($event,col.isEdit,item,col.field,rowIndex,noFrozenCols)"
                                     @dblclick.stop="rowCellDbClick(rowIndex,item,col)"
                                     @contextmenu.prevent="contentMenuClick($event,internalTableData,col.field,'content',rowIndex)"
                                ...
                                >
                                  ...
                                  <span :class="col.isEdit?'text-sapn':'disable-text-span'" v-else v-html="cellMerge(rowIndex,item,col.field).content">
                                  </span>
                                </div>
                                <!--不存在列合并-->
                                <div v-else
                                ...
                                >
                                <span class="conponent-span" v-if="typeof col.componentName ==='string' && col.componentName.length > 0">
                                    <component class="conponent-span" :rowData="item" :field="col.field ? col.field : ''" :index="rowIndex"
        ...
        <cell-pop-menu
          v-if="isCellPopShow"
          :style="{left:cellPopX+'px',top:cellPopY+'px'}"
          :menuData="cellPopData"
          @menuPopcallBack="menuPopcallBack"
        ></cell-pop-menu>
...
<script>
    ...
    import cellPopMenu from './cellPopMenu.vue'
    ...
    export default {
        ...
        components: {tableEmpty, loading, VCheckboxGroup, VCheckbox, VDropdown,cellPopMenu},
        data(){
            return {
                // 本地列表数据
                internalTableData: [],
